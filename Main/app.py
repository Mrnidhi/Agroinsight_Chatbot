...
def ask():
  ...
  #  print("the random generated result is ",chat_history)
    ...
    if predicted_tag=="crop_yield_prediction":
        ...
        def get_user_input():
            ...
            fields = [
                ...
                ("District name(in capital)", "test_score", None),
                ("Select Season Type", "interview_score2", ["Autumn     ", "Kharif     ", "Rabi       ", "Summer     ", "Whole Year ", "Winter     "]),
                ("Crop", "interview_score3", None),
                ("Area(0-100sq.m)", "interview_score4", None),
                ("Select Soil Type", "interview_score9", ["chalky", "clay", "loamy", "peaty", "sandy", "silt", "silty"]),
                ("Temperature(0-400K)", "temperature", None),
                ("Wind Speed(0-15m/s)", "wind_speed", None),
                ("Precipitation(0-1500mm)", "precipitation", None),
                ("Humidity(0-100%)", "humidity", None),
                ("N(0-1000ppm)", "N", None),
                ("P(0-1000ppm)", "P", None),
                ("K(0-1000ppm)", "K", None),
                ("Pressure(0-1500kpa)", "pressure", None),
            ]
        ...
        def get_user_input():
            ...
            # HTML-like input fields
            fields = [
                ("temperature(0-50°C)", "experience", None),
                ("Humidity(0-100%)", "test_score", None),
                ("Rain fall(0-1500mm2)", "test_score4", None),
    ...
    ("Temperature(0-50°C)", "temperature", None),
    ("Humidity(0-100%)", "humidity", None),
    ("Moisture(0-70%)", "moisture", None),
    ("Nitrogen(0-200ppm)", "nitrogen", None),
    ("Potassium(0-300ppm)", "potassium", None),
    ("Phosphorus(0-50ppm)", "phosphorus", None),
